        ...
        stage('Build Docker Image') {
            steps {
                script {
                    ...
                    sh """
                        docker buildx build --platform linux/amd64,linux/arm64,linux/s390x --provenance=true --sbom=true --build-arg DOCKER_BUILDKIT=${DOCKER_BUILDKIT} --memory 32g --memory-swap 16g ${tags} --push .
                    """
                }
            }
        }
